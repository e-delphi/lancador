...
type
  ...
  private
    ...
    FResponse: TResponse;
    FAuth: TAuth;
    FReceiveData: TReceiveDataEvent;
    function GetURI: String;
  protected
    ResponseClass: TResponseClass;
    function InternalExecute: TRESTAPI; virtual;
    procedure InternalReceiveData(const Sender: TObject; AContentLength: Int64; AReadCount: Int64; var AAbort: Boolean);
  ...
  public
    ...
    function ReceiveData(Value: TReceiveDataEvent): TRESTAPI; virtual;
...
begin
  ...
  Client.OnReceiveData := InternalReceiveData;
end;
...
function TRESTAPI.ReceiveData(Value: TReceiveDataEvent): TRESTAPI;
begin
  Result := Self;
  FReceiveData := Value;
end;
...
procedure TRESTAPI.InternalReceiveData(const Sender: TObject; AContentLength, AReadCount: Int64; var AAbort: Boolean);
begin
  if Assigned(FReceiveData) then
    FReceiveData(Sender, AContentLength, AReadCount, AAbort);
end;
